	...
	<div class="row">
		<div class="col-md-12">
			<div class="border p-3">
				...
				<div class="col-md-12">
					<div class="container">
						<p>Bạn đã có tài khoản ? <a href="nguoidung.jsp">Đăng nhập</a> tại đây</p>
						<div class="text-center">
							<h2 class="text-primary">Đăng Kí</h2>
							<p class="text-muted ">Hãy đăng kí để nhận được nhiều thông báo về khuyến mãi và nhiều hơn nữa</p>
						</div>
						<form>
							<!--hang 1-->
							<div class="row">
							...
							<div class="row">
								...
								<div class = "col">
									<div class="mb-3">
										<p>Số tài khoản ngân hàng (không bắt buộc)</p>
										<input type="text" class="form-control">
									</div>
								</div>
							</div>
							...
							<div class="row mt-2 justify-content-between">
								<div class="col-6">
								<input type="checkbox">
								<label>Tôi đã đọc và đồng ý với <a href="chinhsachbaohanh.jsp">Điều khoản sử dụng</a> </label>
								</div>
							</div>
							<div class="row justify-content-center">
								<div class="col-3">
									<button type="button" class="btn btn-primary w-100 mb-3">Đăng kí</button>
								</div>
							</div>
					</form>
							</div>
